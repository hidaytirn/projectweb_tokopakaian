...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <a href="view_page.php?pid=<?= $fetch_wishlist['pid']; ?>"><img src="uploaded_img/<?= $fetch_wishlist['image']; ?>" alt=""></a>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn2 <?= ($grand_total > 1)?'':'disabled'; ?>">delete all</a>
   </div>
